...
<h3 id="aaravhead">LOGIN</h3>
<hr>

<form action="" method="post">
  <div class="form-group">
    <label id ="aarav"for="exampleInputEmail1">Username</label>
    <input type="text" name="username" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter Username">
  </div><br>
  <div class="form-group">
    <label id="aarav" for="exampleInputPassword1">Password</label>
  ...
  <a id="new123456" href="register.php">New to THE APEX? Create Account</a>
</form>
